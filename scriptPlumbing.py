...
dataSet = open("rowdataPlumbing.txt", "r")
# print(dataSet.read())
...
for i in range(301):
    if(i/10 < 1):
        id.append('P' + '0000' + str(i))
    elif(i/100 < 1):
        id.append('P' + '000' + str(i))
    elif(i/1000 < 1):
        id.append('P' + '00' + str(i))
    elif(i/10000 < 1):
        id.append('P' + '0' + str(i))
    else:
        id.append('P' +  str(i))
...
#   cur.execute(create_script)
  ...
  # for i in range(301):
  #       insert_script = 'INSERT INTO application_t (application_id, application_name, application_integrity, application_insulation, application_type, application_wallfloor, application_construction_type, application_subcategory, application_thickness) VALUES (%s, %s, %s, %s, %s, %s, %s,%s, %s)'
  #       insert_value = [id[i], productName[i], integrety[i], insulation[i], 'p', wallFloor[i], constructionType[i], subC[i], thickness[i]]
  ...
  for i in range(301):
        insert_script = 'INSERT INTO plumbing_t (plumbing_id, plumbing_pipe_type, plumbing_pipe_size) VALUES (%s, %s, %s)'
